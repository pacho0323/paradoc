package com.bancolombia.certificacion.paradoc.task;
	...
	public class IngresarConceptoReteica implements Task{
		...
		public IngresarConceptoReteica() {
		...
		public static IngresarConceptoReteica enElSistema() {
			return Tasks.instrumented(IngresarConceptoReteica.class);
		}

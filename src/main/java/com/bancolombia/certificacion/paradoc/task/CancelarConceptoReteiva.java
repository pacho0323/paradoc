	...
	public class CancelarConceptoReteiva implements Task{
		...
		public CancelarConceptoReteiva() {
		...
		public static CancelarConceptoReteiva enElSistema() {
			return Tasks.instrumented(CancelarConceptoReteiva.class);
		}

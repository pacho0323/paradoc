...
public class IngresarRteIca implements Task{

	@Override
	public <T extends Actor> void performAs(T actor) {
		// TODO Auto-generated method stub
		actor.attemptsTo(Click.on(MENU_CERTIFICADO),
				Mantener.elemento(MENU_CONFIGURACION_CERTIFICADO,OPCION_CTRETEICA_CERTIFICADO,ENCABEZADO_CTRETEICA)
				);
		
	}
	public static IngresarRteIca opcion() {
		return new IngresarRteIca();
	    }
}
